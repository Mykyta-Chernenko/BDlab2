...
namespace Salary.SalaryDataSetTableAdapters {
...
SELECT Id, Name, Surname, Patronic, BirthDate, StartWork FROM Worker WHERE (Id = @Id)";
        ...
        public virtual int Fill(SalaryDataSet.WorkerDataTable dataTable) {
        ...
        public virtual SalaryDataSet.WorkerDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            SalaryDataSet.WorkerDataTable dataTable = new SalaryDataSet.WorkerDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(SalaryDataSet.WorkerDataTable dataTable) {
